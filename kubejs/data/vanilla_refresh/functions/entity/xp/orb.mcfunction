...
execute if score @s refresh_count matches 20.. run particle dust_color_transition 0.969 1.000 0.000 1 0.031 0.451 1.000 ~ ~ ~ 0 0 0 1 0 force @a[distance=..64]
...
execute if score @s refresh_count matches 20.. at @s run particle dust_color_transition 0.969 1.000 0.000 1 0.031 0.451 1.000 ~ ~ ~ 0 0 0 1 0 force @a[distance=..64]
