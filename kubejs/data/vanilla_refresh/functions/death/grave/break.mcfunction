...
execute positioned ~ ~1 ~ if block ~ ~ ~ cobblestone run particle block cobblestone ~ ~ ~ .3 .3 .3 .2 50 normal
execute positioned ~ ~ ~ if block ~ ~ ~ andesite run particle block andesite ~ ~ ~ .3 .3 .3 .2 50 normal
execute if block ^ ^ ^1 player_head run particle block andesite ^ ^ ^1 .3 .3 .3 .2 50 normal
