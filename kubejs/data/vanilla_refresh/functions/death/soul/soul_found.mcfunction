...
execute if score @s refresh_count matches 100 run playsound minecraft:entity.glow_squid.squirt player @a[distance=..32] ~ ~ ~ 3 .5
execute if score @s refresh_count matches 100 run playsound minecraft:entity.glow_squid.squirt player @a[distance=..32] ~ ~ ~ 3 .5
execute if score @s refresh_count matches 100 run playsound minecraft:entity.glow_squid.squirt player @a[distance=..32] ~ ~ ~ 3 .6

execute if score @s refresh_count matches 100 run playsound block.amethyst_cluster.break player @a[distance=..32] ~ ~ ~ 3 .5
execute if score @s refresh_count matches 100 run playsound block.amethyst_cluster.break player @a[distance=..32] ~ ~ ~ 3 .75
execute if score @s refresh_count matches 100 run playsound block.amethyst_cluster.break player @a[distance=..32] ~ ~ ~ 3 .5
execute if score @s refresh_count matches 100 run playsound block.amethyst_cluster.break player @a[distance=..32] ~ ~ ~ 3 .5
...
#returns your items
execute as @s[tag=refresh_entity_playersoul_hasitems] if score @s refresh_count matches 100 run summon item ~ ~ ~ {Item:{id:"minecraft:bundle",Count:1b,tag:{VanillaRefreshBundle:1}},Fire:60s,PickupDelay:5,Tags:["refresh_entity_soulitem","refresh_entity_soulitem_bundle"],NoGravity:1b}
execute as @s[tag=refresh_entity_playersoul_hasitems] if score @s refresh_count matches 100 run data modify entity @e[limit=1,sort=nearest,type=item,nbt={Item:{id:"minecraft:bundle"}}] Item.tag.Items set from entity @s data.Inventory
...
execute if score @s refresh_count matches 100..105 run particle flash ~ ~ ~ 0 0 0 0 4 force @a[distance=..128]
...
execute if score @s refresh_count matches 100..120 run particle end_rod ~ ~ ~ 0 0 0 .25 8 force @a[distance=..128]
