...
execute unless block ~ ~-0.1 ~ #vanilla_refresh:permeable run scoreboard players reset @s refresh_totemtime
execute unless block ~ ~-0.1 ~ #vanilla_refresh:permeable run scoreboard players reset @s refresh_totemtime2
execute unless block ~ ~-0.1 ~ #vanilla_refresh:permeable run tag @s remove 1_splatus_actionbar_disabled_2
execute unless block ~ ~-0.1 ~ #vanilla_refresh:permeable run effect clear @s levitation
execute unless block ~ ~-0.1 ~ #vanilla_refresh:permeable run scoreboard players reset @s refresh_totemtime2_tick
...
execute if score @s[predicate=vanilla_refresh:condition/sneaking] refresh_totemtime matches 11..1180 run effect give @s levitation 1 250 true
