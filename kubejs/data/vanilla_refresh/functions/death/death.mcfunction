execute if score death_sound refresh_settings matches 10 run loot spawn ~ ~ ~ loot vanilla_refresh:other/randomize_9
execute if score death_sound refresh_settings matches 10 store result score temp refresh_randomizer_output run data get entity @e[distance=..0.01,type=item,limit=1,nbt={Item:{tag:{RefreshRandomizerItem:1}}}] Item.tag.RefreshRandomizerOutput
kill @e[distance=..0.01,type=item,limit=1,sort=nearest,nbt={Item:{tag:{RefreshRandomizerItem:1}}}]
...
execute if score death_sound_local refresh_settings matches 11 at @s run function vanilla_refresh:death/sound/a_main_local
...
scoreboard players reset @s refresh_randomizer_output
kill @e[distance=..0.01,type=item,limit=1,sort=nearest,nbt={Item:{tag:{RefreshRandomizerItem:1}}}]



#soul
execute if score gamerule_keepInventory refresh_settings matches 1 if score soul refresh_settings matches 1.. run function vanilla_refresh:death/soul/death
