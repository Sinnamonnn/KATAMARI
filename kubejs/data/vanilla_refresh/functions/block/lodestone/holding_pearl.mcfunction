...
execute if score second refresh_count matches 1 positioned ~ ~1.4 ~ as @e[type=marker,tag=refresh_entity_lodestone_teleport,distance=..96] facing entity @s feet positioned ^ ^ ^2 run function vanilla_refresh:block/lodestone/raycast_anim
