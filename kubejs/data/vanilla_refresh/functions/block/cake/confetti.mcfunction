...
particle firework ~ ~.3 ~
execute if score @s[tag=!refresh_entity_confetti2] refresh_count matches 10.. if predicate vanilla_refresh:chance/10_percent run function vanilla_refresh:block/cake/firework3
