...
execute as @s[tag=refresh_temp224] if score mob_health refresh_settings matches 1 run tellraw @s [{"translate": "","color": "gray"},{"translate": "ⓘ ","hoverEvent":{"action":"show_text","contents":[{"translate":"The mob health text displayed on player actionbars when they near a mob"}]}},{"translate":"Mob Health Display: ","color":"gray"},{"translate":"Enabled","color":"green","underlined":true,"hoverEvent":{"action":"show_text","contents":[{"translate":"Click to change this setting"}]},"clickEvent":{"action":"run_command","value":"/function vanilla_refresh:other/actions/mob/mob_health_disable"}},{"translate":"  "},{"translate":"Successfully Optimized!","italic": true,"color":"gray"}]
execute as @s[tag=refresh_temp224] if score mob_health refresh_settings matches 0 run tellraw @s [{"translate": "","color": "gray"},{"translate": "ⓘ ","hoverEvent":{"action":"show_text","contents":[{"translate":"The mob health text displayed on player actionbars when they near a mob"}]}},{"translate":"Mob Health Display: ","color":"gray"},{"translate":"Disabled","color":"red","underlined":true,"hoverEvent":{"action":"show_text","contents":[{"translate":"Click to change this setting"}]},"clickEvent":{"action":"run_command","value":"/function vanilla_refresh:other/actions/mob/mob_health_enable"}},{"translate":"  "},{"translate":"Successfully Optimized!","italic": true,"color":"gray"}]

execute as @s[tag=!refresh_temp224] if score mob_health refresh_settings matches 1 run tellraw @s [{"translate": "","color": "gray"},{"translate": "ⓘ ","hoverEvent":{"action":"show_text","contents":[{"translate":"The mob health text displayed on player actionbars when they near a mob"}]}},{"translate":"Mob Health Display: ","color":"gray"},{"translate":"Enabled","color":"green","underlined":true,"hoverEvent":{"action":"show_text","contents":[{"translate":"Click to change this setting"}]},"clickEvent":{"action":"run_command","value":"/function vanilla_refresh:other/actions/mob/mob_health_disable"}},{"translate":"  "},{"translate":"Optimize","color":"light_purple","underlined":true,"hoverEvent":{"action":"show_text","contents":[{"translate":"Click to run this command\nClears all mob health scores for entities that no longer exist as well as reload current entity scores. Helpful for reducing the size of your world's scoreboard.dat file"}]},"clickEvent":{"action":"run_command","value":"/function vanilla_refresh:other/actions/mob/mob_health_optimize"}}]
execute as @s[tag=!refresh_temp224] if score mob_health refresh_settings matches 0 run tellraw @s [{"translate": "","color": "gray"},{"translate": "ⓘ ","hoverEvent":{"action":"show_text","contents":[{"translate":"The mob health text displayed on player actionbars when they near a mob"}]}},{"translate":"Mob Health Display: ","color":"gray"},{"translate":"Disabled","color":"red","underlined":true,"hoverEvent":{"action":"show_text","contents":[{"translate":"Click to change this setting"}]},"clickEvent":{"action":"run_command","value":"/function vanilla_refresh:other/actions/mob/mob_health_enable"}},{"translate":"  "},{"translate":"Optimize","color":"light_purple","underlined":true,"hoverEvent":{"action":"show_text","contents":[{"translate":"Click to run this command\nClears all mob health scores for entities that no longer exist as well as reload current entity scores. Helpful for reducing the size of your world's scoreboard.dat file"}]},"clickEvent":{"action":"run_command","value":"/function vanilla_refresh:other/actions/mob/mob_health_optimize"}}]
