...
#water
execute if score anim_water refresh_settings matches 1 as @a at @s run function vanilla_refresh:player/anim_water

scoreboard players set 2tick refresh_count 0