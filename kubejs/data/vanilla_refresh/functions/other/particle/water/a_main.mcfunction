...
execute at @s run particle dust_color_transition 0.541 0.710 1.000 1.2 1.000 1.000 1.000 ~ ~ ~ .3 .3 .3 1 0 force @a[distance=..128]
execute at @s run particle minecraft:splash ~ ~ ~ 0 0 0 0 10 force @a[distance=..64]
