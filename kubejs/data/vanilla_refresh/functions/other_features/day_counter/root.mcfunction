...
execute if score daycounter refresh_settings matches 1.. if score daytime refresh_daycounter matches 1 as @a at @s unless entity @e[distance=..256,type=ender_dragon] run scoreboard players add @s refresh_daycounter2 0
