...
tellraw @s [{"translate": "  ","color": "gray"},{"translate":"Soul Links Take/Store Items: ","color":"gray"},{"score":{"name": "soul_takeitems","objective": "refresh_settings"},"color": "yellow"},{"translate": "","color": "yellow"}]
tellraw @s [{"translate": "  ","color": "gray"},{"translate":"Soul Link Expiration: ","color":"gray"},{"score":{"name": "soul_despawntime","objective": "refresh_settings"},"color": "yellow"},{"translate": " minutes","color": "yellow"}]
tellraw @s [{"translate": "  ","color": "gray"},{"translate":"Soul Link Percent XP Returned: ","color":"gray"},{"score":{"name": "soul_percentxp","objective": "refresh_settings"},"color": "yellow"},{"translate": "%","color": "yellow"}]
